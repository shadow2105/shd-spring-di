...
import com.example.shdspringdi.config.ComConstructorConfig;
...
public class ShdSpringDiApplication {
	...
	public static void main(String[] args) {
		...
		//--------------------- Configuration Properties Constructor Binding --------------------------
		System.out.println("\n-------- Configuration Properties Constructor Binding --------");
		ComConstructorConfig comConstructorConfig = aCtx.getBean(ComConstructorConfig.class);

		System.out.println(comConstructorConfig.getUsername());
		System.out.println(comConstructorConfig.getPassword());
		System.out.println(comConstructorConfig.getJdbcurl());
